        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm pt-5'>
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-[#363636]'>
                    ...
                    {isEdit
                        ? <p>
                            <input className='bg-gray-50 border border-gray-300 rounded-sm p-2 ' type="text" onChange={(e) => setUserData(prev => ({ ...prev, address: { ...prev.address, line1: e.target.value } }))} value={userData.address.line1} /></p>
                        : <p className='text-gray-500 border border-gray-300 rounded-md p-2'>{userData.address.line1} <br /> {userData.address.line2}</p>
                    }
